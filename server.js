    ...
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "admin" || req.session.role === "biblio") {
            ...
            .then(function(dataSnapshot) {
                ...
                res.render(`${req.session.role}/home`, {data: data});
            });
        }
        else {
            firebase.database().ref().once('value')
            .then(function(dataSnapshot) {
                ...
                res.render("reader/home", {data: data});
            });
        }
...
app.get('/account', (req, res) => {
    if (req.session.user && req.cookies.user_sid) {
        ...
        .then(function(dataSnapshot) {
            res.render(`${req.session.role}/account`, {data: dataSnapshot.val()});
        });
    } else {
        res.redirect('/login');
    }
...
app.route('/account/edit')
    .get((req, res) => {
        if (req.session.user && req.cookies.user_sid) {
            firebase.database().ref("users/" +  req.session.user).once('value')
            .then(function(dataSnapshot) {
                res.render(`${req.session.role}/account-edit`, {data: dataSnapshot.val()});
            });
        } else {
            res.redirect('/login');
        }
...
app.get('/account/edit', (req, res) => {
    if (req.session.user && req.cookies.user_sid) {
        firebase.database().ref("users/" +  req.session.user).once('value')
        .then(function(dataSnapshot) {
            res.render("account", {data: dataSnapshot.val()});
        });
    } else {
        res.redirect('/login');
    }
    ...
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "admin") {
            ...
            .then(function(dataSnapshot) {
                ...
                res.render("admin/users", {data: array});
            });
        }
            ...
            .then(function(dataSnapshot) {
                ...
                res.render("biblio/users", {data: data});
            });
        }
        else {
            res.render("error", {error: "Доступ заборонено"});
        }
    } else {
        res.redirect('/login');
    }
...
app.get('/users/:id', (req, res) => {
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "admin" || req.session.role === "biblio") {
            ...
            .then(function(dataSnapshot) {
                res.render(`${req.session.role}/user-info`, {data: dataSnapshot.val()});
            });
        }
        else {
            res.render("error", {error: "Доступ заборонено"});
    ...
    .get((req, res) => {
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "admin" || req.session.role === "biblio") {
                firebase.database().ref().child('/users/' + req.params.id).once('value')
                .then(function(dataSnapshot) {
                    res.render(`${req.session.role}/edit-user`, {data: dataSnapshot.val()});
                });
            }
            else {
                res.render("error", {error: "Доступ заборонено"});
    ...
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "admin" || req.session.role === "biblio") {
            ...
            .then(function(dataSnapshot) {
                ...
                res.render(`${req.session.role}/books`, {data: data});
            });
        }
        else {
            firebase.database().ref().once('value')
            .then(function(dataSnapshot) {
                ...
                res.render("reader/books", {data: data});
            });
        }
    } else {
        res.redirect('/login');
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "biblio") {
                ...
                .then(function(dataSnapshot) {
                    var authors = dataSnapshot.val().authors;
                    var sections = dataSnapshot.val().sections;
                    res.render("biblio/add-book", {authors: authors, sections: sections});
                });
            }
            else {
                res.render("error", {error: "Доступ заборонено"});
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "admin" || req.session.role === "biblio") {
                ...
                .then(function(dataSnapshot) {
                    ...
                    data.desc = book.desc;
                    res.render(`${req.session.role}/book-info`, {data: data});
                });
            }
            else {
                firebase.database().ref().once('value')
                .then(function(dataSnapshot) {
                    ...
                    res.render("reader/book-info", {data: mydata});
                });
            }
        } else {
            res.redirect('/login');
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "biblio") {
                ...
                .then(function(dataSnapshot) {
                    ...
                    res.render("biblio/edit-book", {book: book, authors: authors, sections: sections});
                });
            }
            else {
                res.render("error", {error: "Доступ заборонено"});
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "reader") {
                ...
                .then(function(dataSnapshot) {
                    ...
                    res.render("reader/top100", {data: data});
                });
            }
            else {
                res.redirect("/books");
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "reader") {
                ...
                .then(function(dataSnapshot) {
                    ...
                    res.render("reader/favourites", {data: data});
                });
            }
            else {
                res.redirect("/books");
    ...
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "admin" || req.session.role === "biblio") {
            ...
            .then(function(dataSnapshot) {
                ...
                data.sort(orderByName);
                res.render(`${req.session.role}/sections`, {data: data});
            });
        }
        else {
            res.redirect("/dashboard");
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "admin" || req.session.role === "biblio") {
                ...
                .then(function(dataSnapshot){
                    ...
                    res.render(`${req.session.role}/section-info`, {section: sectionData, books: data});
                });
            }
            else {
                firebase.database().ref().once('value')
                .then(function(dataSnapshot) {
                    ...
                    res.render("reader/section-info", {name: name, data: data});
                });
            }
        } else {
            res.redirect('/login');
    ...
    .get((req, res) => {
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "biblio") {
                ...
                .then(function(dataSnapshot) {
                    res.render("biblio/edit-section", {data: dataSnapshot.val()});
                });
            }
            else {
                res.render("error", {error: "Доступ заборонено"});
    ...
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "admin" || req.session.role === "biblio") {
            ...
            .then(function(dataSnapshot) {
                ...
                res.render(`${req.session.role}/authors`, {data: data});
            });
        }
        else {
            firebase.database().ref().once('value')
            .then(function(dataSnapshot) {
                ...
                res.render("reader/authors", {data: data});
            });
        }
    } else {
        res.redirect('/login');
...
app.get('/authors/:id', (req, res) => {
    if (req.session.user && req.cookies.user_sid) {
        ...
        .then(function(dataSnapshot){
            ...
            res.render(`${req.session.role}/author-info`, {author: authorData, books: data});
        });
        }
        else {
            firebase.database().ref().once('value')
            .then(function(dataSnapshot) {
                ...
                res.render("reader/author-info", {name: `${first_name} ${last_name}`, data: data});
            });
        }
    } else {
        res.redirect('/login');
...
.get((req, res) => {
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "biblio") {
            ...
            .then(function(dataSnapshot) {
                res.render("biblio/edit-author", {data: dataSnapshot.val()});
            });
        }
        else {
            res.render("error", {error: "Доступ заборонено"});
    ...
    if (req.session.user && req.cookies.user_sid) {
        if(req.session.role === "biblio") {
            ...
            .then(function(dataSnapshot) {
                ...
                res.render("biblio/orders", {data: data.reverse()});
            });
        }
            ...
            .then(function(dataSnapshot) {
                ...
                res.render("reader/orders", {data: data.reverse()});
            });
        }
        else {
            res.redirect('/dashboard');
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "biblio") {
                ...
                .then(function(dataSnapshot) {
                    ...
                    res.render("biblio/giving", {books: books, users: readers});
                });
            }
            else {
                res.render("error", {error: "Доступ заборонено"});
        ...
        if (req.session.user && req.cookies.user_sid) {
            if(req.session.role === "biblio") {
                ...
                .then(function(dataSnapshot) {
                    ...
                    res.render("biblio/return", {data: data});
                });
            }
            else {
                res.render("error", {error: "Доступ заборонено"});
...
app.get('*', function(req, res){
    res.render("error", {error: "Такої сторінки не існує"});
});
